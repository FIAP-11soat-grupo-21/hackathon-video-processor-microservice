resource "aws_lambda_event_source_mapping" "chunk_processor_trigger" {
  event_source_arn = data.terraform_remote_state.sqs_chunk_processor.outputs.queue_arn
...
resource "aws_lambda_event_source_mapping" "update_status_trigger" {
  event_source_arn = data.terraform_remote_state.sqs_update_video_chunk_status.outputs.queue_arn
...
resource "aws_lambda_event_source_mapping" "zip_processor_trigger" {
  event_source_arn = data.terraform_remote_state.sqs_zip_processor.outputs.queue_arn
